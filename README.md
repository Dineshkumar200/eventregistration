...
<body>
    <div class="jumbotron">
      ...
      background-image: url('https://blog.equinix.com/wp-content/uploads/2018/02/IoT.jpg');
      ...
      height: 600px;background-repeat: no-repeat;background-size: cover;">
            ...
            <div class="row">
                <div class="col-12" style="">
                    <h1 class="text-center display-4" style=color:White>One day Workshop on internet of thing</h1>
                </div>
            </div>
            ...
            <div class="row">
        <div class="col-12 text-center" style="pad padding-top: 50%;">
            <a href="/register/" class="btn btn-primary btn-lg" role="button" aria-pressed="true">Register Now</a>
        </div>
        <div class="row">
                <div class="col-12 display-8 text-center" style="padding-top: 14%">
                    <h1 class="text-center display-4" style="background-color:DodgerBlue;">Last date for apply</h1>
                    <h4 class="text-center display-4" style="background-color:rgb(200, 200, 200);">28.02.2020</h4>
                </div>
            </div>
...
<body>
    ...
    <form action="" method="POST">
        {% csrf_token %}
        <div class="container display-8 text-center" style=color:#5547Cb >
...
<body>
    <div class="jumbotron">
      ...
      height: 900px;background-repeat: no-repeat;background-size: cover;">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center" style=color:aliceblue>Your registration is success👍🏻👍🏻</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center" style="padding-top: 8%">
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="text-center" style= color:aliceblue>Your registration is Failed😔😔</h1>
            </div>
        </div>
        <div class="row">
            <div class="col-12 text-center"style="padding-top: 8%">
...
![output](./static/img/p10.jpg)
![output](./static/img/p11.jpg)



## RESULT:
 Thus, a UX design and develop a web application for event registration has been done and the hostred URL http://dineshkumar.student.saveetha.in:8000/home/.